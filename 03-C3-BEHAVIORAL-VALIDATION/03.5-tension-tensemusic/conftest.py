...
def engine_cache_dir(project_root) -> Path:
    ...
    candidates = [
        project_root / "V-Reproduction" / "Musical_Intelligence_Outputs" / "emotion" / "TenseMusic" / "per_frame",
        project_root / "Science" / "V-Reproduction" / "Musical_Intelligence_Outputs" / "emotion" / "TenseMusic" / "per_frame",
    ]
    for c in candidates:
        if c.exists():
            return c
